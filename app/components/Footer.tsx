            ...
            <div className="container">
                <div className="footer-content">
                    ...
                    <div className="footer-social">
                        <a href="#" aria-label="GitHub (Coming soon)" className="social-link">
                        ...
                        <a href="https://zalo.me/0344396798" aria-label="Zalo" className="social-link" target="_blank" rel="noopener noreferrer">
                            <svg viewBox="0 0 24 24" fill="currentColor">
